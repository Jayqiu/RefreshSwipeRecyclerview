 ...
 */
public class ActRefreshStaggeredGridView extends FragmentActivity {

    @Bind(R.id.refreshStaggeredGridRecyclerView)
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_layout_refresh_staggeredview);
        ...
        mRsRecyclerView.setOnItemClickListener(new RefreshRecyclerView.OnItemClickListener() {
            ...
            public void onItemClick(RefreshRecyclerView refreshRecyclerView, View view, int position) {
                ...
                Toast.makeText(ActRefreshStaggeredGridView.this, "onItemClick = " + position, Toast.LENGTH_SHORT).show();
            }
        });
        mRsRecyclerView.setOnItemLongClickListener(new RefreshRecyclerView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(RefreshRecyclerView refreshRecyclerView, View view, int position) {
                ...
                Toast.makeText(ActRefreshStaggeredGridView.this, "onItemLongClick = " + position, Toast.LENGTH_SHORT).show();
                return true;
            }
        });
...
//                        mRsRecyclerView.loadMoreError();
        ...
        mRecyclerView.setSwipeMenuItemClickListener(new OnSwipeMenuItemClickListener() {
            ...
            public void onItemClick(Closeable closeable, int adapterPosition, int menuPosition, @RefreshRecyclerView.DirectionMode int direction) {
                Toast.makeText(ActRefreshStaggeredGridView.this, adapter.getData().get(adapterPosition), Toast.LENGTH_SHORT).show();
        ...
        mRsRecyclerView.setAdapter(adapter);
        adapter.addFirst(mDatas);
    }
    ...
    private SwipeMenuCreator swipeMenuCreator = new SwipeMenuCreator() {
        ...
        public void onCreateMenu(SwipeMenu swipeLeftMenu, SwipeMenu swipeRightMenu, int viewType) {
            int width = dip2px(ActRefreshStaggeredGridView.this, 40);
            ...
            {
                SwipeMenuItem deleteItem = new SwipeMenuItem(ActRefreshStaggeredGridView.this)
    ...
    public class MyAdapter extends BaseRvAdapter<String> {
        ...
        public int getItemLayoutID(int viewType) {
            return R.layout.item_view_staggered_grid;
        }
