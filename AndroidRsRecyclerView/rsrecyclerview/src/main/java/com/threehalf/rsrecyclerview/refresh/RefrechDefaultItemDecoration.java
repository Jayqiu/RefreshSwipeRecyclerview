 ...
 * @author jayqiu
 * @describe
 * @date 2017/2/15 10:42
 */
public class RefrechDefaultItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private int mLayoutManagerType = RefreshRecyclerView.LAYOUT_MANAGER_TYPE_LINEAR; // FamiliarRecyclerView.LAYOUT_MANAGER_TYPE_*
    ...
    public RefrechDefaultItemDecoration(RefreshRecyclerView refreshRecyclerView, Drawable dividerVertical, Drawable dividerHorizontal, int dividerDrawableSizeVertical, int dividerDrawableSizeHorizontal) {
    ...
    private void initLayoutManagerType() {
        this.mLayoutManagerType = mRefreshRecyclerView.getCurLayoutManagerType();
        RecyclerView.LayoutManager layoutManager = mRefreshRecyclerView.getLayoutManager();
        switch (mLayoutManagerType) {
            case RefreshRecyclerView.LAYOUT_MANAGER_TYPE_LINEAR:
                ...
                break;
            case RefreshRecyclerView.LAYOUT_MANAGER_TYPE_GRID:
                ...
                break;
            case RefreshRecyclerView.LAYOUT_MANAGER_TYPE_STAGGERED_GRID:
                ...
                break;
            default:
                this.mLayoutManagerType = RefreshRecyclerView.LAYOUT_MANAGER_TYPE_LINEAR;
        }
    ...
    private void drawDividerDrawable(Canvas c, RecyclerView parent) {
        ...
        RefreshRecyclerView curFamiliarRecyclerView = null;
        if (parent instanceof RefreshRecyclerView) {
            curFamiliarRecyclerView = (RefreshRecyclerView) parent;
        ...
        for (int i = 0; i < parent.getChildCount(); i++) {
            ...
            if (mLayoutManagerType == RefreshRecyclerView.LAYOUT_MANAGER_TYPE_LINEAR
            ...
            switch (mLayoutManagerType) {
                ...
                case RefreshRecyclerView.LAYOUT_MANAGER_TYPE_STAGGERED_GRID:
                    ...
                    if (mLayoutManagerType == RefreshRecyclerView.LAYOUT_MANAGER_TYPE_GRID && position == (itemViewCount + headersCount - 1)) {
                    ...
                    if (mOrientation == OrientationHelper.HORIZONTAL) {
                        ...
                        if (!isNotShowGridEndDivider || (!isGridLayoutLastNum && !isGridItemLayoutLastColumn)) {
                            ...
                            if (mLayoutManagerType == RefreshRecyclerView.LAYOUT_MANAGER_TYPE_STAGGERED_GRID && !isGridItemLayoutLastRow) {
                        ...
                        if (isGridItemLayoutFirstRow) {
                        ...
                        } else if (mLayoutManagerType == RefreshRecyclerView.LAYOUT_MANAGER_TYPE_GRID && isGridItemLayoutLastRow) {
                            ...
                            if (mLayoutManagerType == RefreshRecyclerView.LAYOUT_MANAGER_TYPE_GRID && !isGridItemLayoutLastColumn) {
                        ...
                        if (!isNotShowGridEndDivider || (!isGridItemLayoutLastColumn
                                && ((mLayoutManagerType == RefreshRecyclerView.LAYOUT_MANAGER_TYPE_GRID && !isGridLayoutLastNum)
                                || mLayoutManagerType == RefreshRecyclerView.LAYOUT_MANAGER_TYPE_STAGGERED_GRID))) {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        // set itemView
        if (mLayoutManagerType == RefreshRecyclerView.LAYOUT_MANAGER_TYPE_GRID || mLayoutManagerType == RefreshRecyclerView.LAYOUT_MANAGER_TYPE_STAGGERED_GRID) {
    ...
    private void processGridOffsets(Rect outRect, int position, int headersCount, View view) {
        int curGridNum;
        if (mLayoutManagerType == RefreshRecyclerView.LAYOUT_MANAGER_TYPE_GRID) {
    ...
    private boolean isEmptyView(RefreshRecyclerView familiarRecyclerView, int position, int headersCount) {
    ...
    private boolean isGridItemLayoutLastRow(int position, int itemViewCount, int headersCount) {
        if (mLayoutManagerType == RefreshRecyclerView.LAYOUT_MANAGER_TYPE_LINEAR) return false;
    ...
    private boolean isGridItemLayoutLastColumn(int position, int headersCount, View view) {
        ...
        } else if (mLayoutManagerType == RefreshRecyclerView.LAYOUT_MANAGER_TYPE_STAGGERED_GRID) {
