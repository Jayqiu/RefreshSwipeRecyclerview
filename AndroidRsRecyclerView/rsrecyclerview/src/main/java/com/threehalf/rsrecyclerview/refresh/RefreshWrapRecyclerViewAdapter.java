 ...
 * @author jayqiu
 * @describe
 * @date 2017/2/15 10:34
 */
public class RefreshWrapRecyclerViewAdapter extends RecyclerView.Adapter implements View.OnClickListener, View.OnLongClickListener{
    ...
    private int mLayoutManagerType = RefreshRecyclerView.LAYOUT_MANAGER_TYPE_LINEAR;
    ...
    private RefreshRecyclerView.OnHeadViewBindViewHolderListener mOnHeadViewBindViewHolderListener;
    private RefreshRecyclerView.OnFooterViewBindViewHolderListener mOnFooterViewBindViewHolderListener;
    private List<Integer> mHeadOrFooterInitInvokeViewBindViewFlag = new ArrayList<>();

    public RefreshWrapRecyclerViewAdapter(RefreshRecyclerView refreshRecyclerView, RecyclerView.Adapter reqAdapter, List<View> mHeaderView, List<View> mFooterView, int layoutManagerType) {
    ...
    public int getItemCount() {
        ...
        if (mRefreshRecyclerView.isKeepShowHeadOrFooter()) {
    ...
    public int getItemViewType(int position) {
        ...
        } else if (mRefreshRecyclerView.isKeepShowHeadOrFooter()) {
            // empty view
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            case VIEW_TYPE_HEADER: {
                ...
                if (mLayoutManagerType == RefreshRecyclerView.LAYOUT_MANAGER_TYPE_STAGGERED_GRID) {
            ...
            case VIEW_TYPE_EMPTY_VIEW: {
                ...
                View emptyView = mRefreshRecyclerView.getEmptyView();
    ...
    public void setOnItemClickListener(RefreshRecyclerView.OnItemClickListener mOnItemClickListener) {
        this.mOnItemClickListener = mOnItemClickListener;
    }

    public void setOnItemLongClickListener(RefreshRecyclerView.OnItemLongClickListener mOnItemLongClickListener) {
    ...
    public void onClick(View v) {
        ...
        if (null != mOnItemClickListener && curTime - mLastClickTime > MIN_INTERVAL_CLICK_TIME) {
            ...
            mOnItemClickListener.onItemClick(mRefreshRecyclerView, v, mRefreshRecyclerView.getChildAdapterPosition(v) - mRefreshRecyclerView.getHeaderViewsCount());
        }
    }
    ...
    public boolean onLongClick(View v) {
        ...
        if (null != mOnItemClickListener && curTime - mLastClickTime > MIN_INTERVAL_CLICK_TIME) {
            mLastClickTime = curTime;
            return mOnItemLongClickListener.onItemLongClick(mRefreshRecyclerView, v, mRefreshRecyclerView.getChildAdapterPosition(v) - mRefreshRecyclerView.getHeaderViewsCount());
        }
        return false;
    }

    public void setOnHeadViewBindViewHolderListener(RefreshRecyclerView.OnHeadViewBindViewHolderListener mOnHeadViewBindViewHolderListener) {
        this.mOnHeadViewBindViewHolderListener = mOnHeadViewBindViewHolderListener;
    }

    public void setOnFooterViewBindViewHolderListener(RefreshRecyclerView.OnFooterViewBindViewHolderListener mOnFooterViewBindViewHolderListener) {
