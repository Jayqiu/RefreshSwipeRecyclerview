...
/**
 * Created by jayqiu on 2016/7/26.
 */
public class SwipeMenuView extends LinearLayout {
    ...
    private RefreshRecyclerView mFamiliarRecyclerView;
    ...
    public void setRecyclerView(RefreshRecyclerView familiarRecyclerView){
    ...
    private OnClickListener mMenuClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            if (mItemClickListener != null && mSwipeSwitch != null && mSwipeSwitch.isMenuOpen()) {
                if(mFamiliarRecyclerView!=null){
                    mItemClickListener.onItemClick(mSwipeSwitch, mAdapterVIewHolder.getAdapterPosition()- mFamiliarRecyclerView.getHeaderViewsCount(), v.getId(), mDirection);
                }else {
