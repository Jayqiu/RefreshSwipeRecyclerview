 ...
 * @author jayqiu
 * @describe
 * @date 2017/2/15 10:29
 */
public class RefrechItemAnimator extends RecyclerView.ItemAnimator{
    ...
    private void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (newView != null) {
            ...
            newViewAnimation.translationX(0).translationY(0).setDuration(getChangeDuration())//delete alpha(1)</span>
                    .setListener(new VpaListenerAdapter() {
                        @Override
                        public void onAnimationStart(View view) {
